package com.marks.smart.count.asset.base.pojo;
...
public class AssetLog implements Serializable {
	...
	public String toLog() {
		return " - id:" + String.valueOf(id) + " - userid:" + String.valueOf(userid) + " - username:"
				+ String.valueOf(username) + " - mobile:" + String.valueOf(mobile) + " - tranType:"
				+ String.valueOf(tranType) + " - itemType:" + String.valueOf(itemType) + " - itemName:"
				+ String.valueOf(itemName) + " - fromer:" + String.valueOf(fromer) + " - toer:" + String.valueOf(toer)
				+ " - createtime:" + String.valueOf(createtime) + " - updatetime:" + String.valueOf(updatetime)
				+ " - tranTime:" + String.valueOf(tranTime) + " - tranYear:" + String.valueOf(tranYear)
				+ " - tranMonth:" + String.valueOf(tranMonth) + " - idNo:" + String.valueOf(idNo) + " - idName:"
