...
// 新增
function add() {
	var path = "refundGood.html?formStatus=new&returnType=0&idNo=1";
	location.href = path;
}
...
function edit() {
	...
	var path = "refundGood.html?formStatus=edit&returnType=0&idNo="
			+ appInfo.selectedId;
	location.href = path;
}
function receive() {
	...
	var path = "refundGood.html?formStatus=receive&returnType=0&idNo="
			+ appInfo.selectedId;
	location.href = path;
}
// 删除
...
function showDetail() {
	...
	var path = "refundGood.html?formStatus=detail&returnType=0&idNo="
			+ appInfo.selectedId;
	location.href = path;
}
// -----------------权限控制功能 end---------------
