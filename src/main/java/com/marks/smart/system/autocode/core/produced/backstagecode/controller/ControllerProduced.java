 ...
 */
package com.marks.smart.system.autocode.core.produced.backstagecode.controller;
...
import com.marks.smart.system.autocode.core.produced.backstagecode.service.ServiceImplProduced;
...
/**
 * File Name:
 * cluster.scheme.autocode.backstagecode.controller.ControllerProduced.java
 * 
...
public class ControllerProduced extends AbstractCodeProduced {
	...
	public String producedPackageUrl(AutoBean autoBean) {
		...
		sBuffer.append(autoBean.getDefaultPackageUrl()).append(DOT_VALUE).append(autoBean.getDefaultController());
		// TODO 改为代理注入方案
	...
	/*
	 * public String producedLowerCode(AutoBean autoBean){ String lowerBeanName
	 * = autoBean.getFactBeanName().toLowerCase(); return lowerBeanName; }
	 */
