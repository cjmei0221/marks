	...
	<div id="editWin" class="easyui-window"
		...
		<div align="center" style="width: 100%;">
			<form id="ff" name="ff" method="post">
				...
				<table>
					<tr>
						<th style="width: 80px; text-align: right;">用户ID&nbsp;&nbsp;:&nbsp;&nbsp;</th>
					...
					<tr>
						<th style="width: 80px; text-align: right;">IP&nbsp;&nbsp;:&nbsp;&nbsp;</th>
						<td><input id="ip" name="ip" class="easyui-validatebox"
							data-options="required:true" style="width: 200px;"></td>
					</tr>
					<tr>
						<th style="width: 80px; text-align: right;">菜单名称&nbsp;&nbsp;:&nbsp;&nbsp;</th>
					...
					<tr>
						...
						<td><input id="opername" name="opername"
							class="easyui-validatebox" data-options="required:true"
							style="width: 200px;"></td>
					</tr>
					<tr>
						<th style="width: 80px; text-align: right;">访问URL&nbsp;&nbsp;:&nbsp;&nbsp;</th>
						<td><input id="retain2" name="retain2"
							class="easyui-validatebox" data-options="required:true"
							style="width: 200px;"></td>
					</tr>
					<tr>
