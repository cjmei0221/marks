 ...
 */
package com.marks.smart.system.autocode.core.produced.backstagecode.service;
...
public class ServiceImplProduced extends AbstractCodeProduced {
	...
	public String producedPackageUrl(AutoBean autoBean) {
		...
		sBuffer.append(autoBean.getDefaultPackageUrl()).append(DOT_VALUE).append(CodeProduced.DEFAULT_SERVICEIMPL);
		// TODO 改为代理注入方案
	...
	public String producedServiceInterfacePackageUrl(AutoBean autoBean) {
		StringBuffer sBuffer = new StringBuffer();
		sBuffer.append(autoBean.getDefaultPackageUrl()).append(DOT_VALUE).append(autoBean.getDefaultService());
	...
	public String producedDaoObject(AutoBean autoBean) {
		...
		sBuffer.append(BANK_VALUE_4).append(DEFAULT_PRIVATE).append(BANK_VALUE_1)
				.append(StringUtil.getUpperCaseChar(autoBean.getFactBeanName())).append(SUFFIX_DAO).append(BANK_VALUE_1)
				.append(StringUtil.getLowerCaseChar(autoBean.getFactBeanName())).append(SUFFIX_DAO).append(SEMI_VALUE);
	...
	public String producedGetMethod(String beanName) {
		...
		sBuffer.append(BANK_VALUE_4).append(DEFAULT_PUBLIC).append(BANK_VALUE_1)
				.append(StringUtil.getUpperCaseChar(beanName)).append(SUFFIX_DAO).append(BANK_VALUE_1)
				.append(DEFAULT_GET).append(StringUtil.getUpperCaseChar(beanName)).append(SUFFIX_DAO).append(LEFT_PATEN)
		...
		sBuffer.append(BANK_VALUE_4).append(BANK_VALUE_4).append(RETURN_VALUE).append(BANK_VALUE_1)
				.append(StringUtil.getLowerCaseChar(beanName)).append(SUFFIX_DAO).append(SEMI_VALUE).append(ENTER_VALUE)
				.append(BANK_VALUE_4).append(RIGHT_BRACKETS);
		sBuffer.append(ENTER_VALUE);
		return sBuffer.toString();
	}
	...
	public String producedSetMethod(String beanName) {
		...
		sBuffer.append(BANK_VALUE_4).append(DEFAULT_PUBLIC).append(BANK_VALUE_1).append(VOID_VALUE).append(BANK_VALUE_1)
				.append(DEFAULT_SET).append(StringUtil.getUpperCaseChar(beanName)).append(SUFFIX_DAO).append(LEFT_PATEN)
				.append(StringUtil.getUpperCaseChar(beanName)).append(SUFFIX_DAO).append(BANK_VALUE_1)
				.append(StringUtil.getLowerCaseChar(beanName)).append(SUFFIX_DAO).append(RIGHT_PATEN)
				.append(LEFT_BRACKETS).append(ENTER_VALUE);
		sBuffer.append(BANK_VALUE_4).append(BANK_VALUE_4).append(THIS_VALUE)
				.append(StringUtil.getLowerCaseChar(beanName)).append(SUFFIX_DAO).append(BANK_VALUE_1)
				.append(EQUAL_VALUE).append(StringUtil.getLowerCaseChar(beanName)).append(SUFFIX_DAO).append(SEMI_VALUE)
