...
function loadList() {
	$('#tbList').datagrid({
		...
		singleSelect : true,
		columns : [ [                 {title:'追踪码',field:'traceId',width:100,align:"center",hidden:true },
                ...
                {title:'采购单号',field:'cgNo',width:100,align:"center"},
                {title:'零售价',field:'price',width:100,align:"center"},
                ...
                {title:'原追踪码',field:'oriTraceId',width:100,align:"center"},
                ...
                {title:'类别ID',field:'typeId',width:100,align:"center"},
                {title:'类别',field:'typeName',width:100,align:"center"},
                {title:'品牌ID',field:'brandId',width:100,align:"center"},
                {title:'品牌',field:'brandName',width:100,align:"center"},
                {title:'生产日期',field:'productDate',width:100,align:"center"},
                {title:'供应商ID',field:'supplierId',width:100,align:"center"},
                {title:'供应商',field:'supplierName',width:100,align:"center"},
                {title:'会员ID',field:'userid',width:100,align:"center"},
                {title:'会员名称',field:'username',width:100,align:"center"},
                {title:'会员手机号',field:'mobile',width:100,align:"center"},
                {title:'入库日期',field:'stockInDate',width:100,align:"center"},
