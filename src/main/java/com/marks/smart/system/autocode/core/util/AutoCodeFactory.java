package com.marks.smart.system.autocode.core.util;
...
import com.marks.smart.system.autocode.core.produced.DBProduced;
import com.marks.smart.system.autocode.core.produced.ModuleProduced;
import com.marks.smart.system.autocode.core.produced.annotation.TableField;
import com.marks.smart.system.autocode.core.produced.annotation.TableName;
...
import com.marks.smart.system.autocode.core.produced.factory.DefaultExternAutoBeanFactory;
...
import com.marks.smart.system.autocode.core.produced.table.MySqlTableProduced;
import com.marks.smart.system.autocode.core.produced.table.OracleTableProduced;
import com.marks.smart.system.autocode.core.produced.util.StringUtils;
import com.marks.smart.system.autocode.core.test.TestCode;
	...
	public void createTable(AutoBean autoBean) {
		...
		if ("oracle".equals(dialect)) {
			try {
				...
				DBProduced util = new OracleTableProduced();
				logger.info(util.createTableSql(autoBean));
				util.createTable(autoBean);
			} catch (Exception e) {

			}
		} else {
			try {
				DBProduced util = new MySqlTableProduced();
				logger.info(util.createTableSql(autoBean));
				util.createTable(autoBean);
			} catch (Exception e) {
