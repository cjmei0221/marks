package com.marks.module.wx.manage.wxchat.pojo;
...
public class WxChatSession implements Serializable {
	...
	public String toLog() {
		return " - session_id:" + String.valueOf(session_id) + " - accountid:" + String.valueOf(accountid)
				+ " - openid:" + String.valueOf(openid) + " - createtime:" + String.valueOf(createtime)
				+ " - createLong:" + String.valueOf(createLong) + " - updatetime:" + String.valueOf(updatetime)
				+ " - c_content:" + String.valueOf(c_content) + " - endtime:" + String.valueOf(endtime);
	}
}