var appInfo = {
	listUrl: top.window.urlBase + '/inner/acctPoint/list.do',//获取用户积分列表接口  AcctPoint
	saveUrl: top.window.urlBase + '/inner/acctPoint/save.do',//保存新增用户积分接口
	updateUrl: top.window.urlBase + '/inner/acctPoint/update.do',//编辑用户积分信息接口
	deleteUrl: top.window.urlBase + '/inner/acctPoint/delete.do',//删除用户积分接口
	selectedId : -1,
	selectedData : {},
	requestParam:{
		page_number : 1,
...
//		toolbar : "#tb",
		...
		columns : [ [                 {title:'系统编号',field:'userid',width:100,align:"center",hidden:true },
                ...
                {title:'失效积分',field:'lossPoint',width:100,align:"center"},
                {title:'即将失效积分',field:'soonPoint',width:100,align:"center"},
