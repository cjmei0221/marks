...
public class WorkStep implements Serializable{
 ...
 public WorkStep(){
	...
	public String toLog(){
		return " - stepId:" +String.valueOf(stepId)+" - companyId:" +String.valueOf(companyId)+" - wrokId:" +String.valueOf(wrokId)+" - createtime:" +String.valueOf(createtime)+" - updatetime:" +String.valueOf(updatetime)+" - step:" +String.valueOf(step)+" - stepName:" +String.valueOf(stepName)+" - roleId:" +String.valueOf(roleId)+" - roleName:" +String.valueOf(roleName)+" - operatorId:" +String.valueOf(operatorId)+" - operatorName:" +String.valueOf(operatorName)+" - endTime:" +String.valueOf(endTime)+" - operateStatus:" +String.valueOf(operateStatus)+" - operatorOrgId:" +String.valueOf(operatorOrgId)+" - operatorOrgName:" +String.valueOf(operatorOrgName)+" - remarks:" +String.valueOf(remarks);
	}
}