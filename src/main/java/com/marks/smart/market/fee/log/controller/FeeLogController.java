package com.marks.smart.market.fee.log.controller;
...
public class FeeLogController extends SupportContorller {
	...
	public void findFeeLogById(HttpServletRequest request, HttpServletResponse response) {
		...
		try {
			FeeLog info = getModel(FeeLog.class,request.getParameterMap());
	...
	public void save(HttpServletRequest request, HttpServletResponse response) {
		...
		try {
			...
			info.setPayeeOrgId(admin.getOrgId());
			info.setPayeeOrgName(admin.getOrgName());
			info.setPayeeCode(admin.getUserCode());
			info.setPayeeName(admin.getUsername());
