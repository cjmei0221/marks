...
public class StockInfo implements Serializable{
 ...
 public StockInfo(){
	...
	public String toLog(){
		return " - stockId:" +String.valueOf(stockId)+" - companyId:" +String.valueOf(companyId)+" - orgId:" +String.valueOf(orgId)+" - orgName:" +String.valueOf(orgName)+" - goodId:" +String.valueOf(goodId)+" - stockNums:" +String.valueOf(stockNums)+" - stockAmount:" +String.valueOf(stockAmount)+" - createtime:" +String.valueOf(createtime)+" - updatetime:" +String.valueOf(updatetime)+" - secondNums:" +String.valueOf(secondNums)+" - secondAmount:" +String.valueOf(secondAmount)+" - holdNums:" +String.valueOf(holdNums)+" - holdAmount:" +String.valueOf(holdAmount)+" - scrapNums:" +String.valueOf(scrapNums)+" - scrapAmount:" +String.valueOf(scrapAmount)+" - giftNums:" +String.valueOf(giftNums)+" - giftAmount:" +String.valueOf(giftAmount)+" - totalNums:" +String.valueOf(totalNums)+" - totalAmount:" +String.valueOf(totalAmount);
	}
}