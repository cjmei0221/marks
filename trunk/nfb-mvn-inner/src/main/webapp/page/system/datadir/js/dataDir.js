...
function loadList() {
	$('#tbList').datagrid({
		...
		singleSelect : true,
		columns : [ [                 {title:'主键',field:'ckey',width:100,align:"center",hidden:true },
                {title:'父主键',field:'parentkey',width:100,align:"center"},
                {title:'主键值',field:'cvalue',width:100,align:"center"},
                {title:'公司ID',field:'typename',width:100,align:"center"},
