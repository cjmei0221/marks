...
import com.grgbanking.common.util.JsonUtil;
import com.grgbanking.common.util.SysCode;
import com.grgbanking.module.wxqyhao.entity.EnterpriseUser;
import com.grgbanking.module.wxqyhao.util.QyAccessTokenUtil;
import com.grgbanking.module.wxqyhao.util.QyGetUrlUtils;
...
//		url = String.format(url, access_token, json.optString("id"));
	...
	public JsonResult deleteEnterpriseUserList(String accountid,List<String> userid)
		...
		JsonUtil.obj2json("useridlist", jsonObject, userid);
		json = jsonObject;
		String access_token=QyAccessTokenUtil.getInstance().getQyAccessToken(accountid);
		logger.info("access_token:"+access_token);
