package com.marks.module.wxfwhao.redPack.util;
...
public class HttpService {
	...
	public static String doSendMoney(String requestUrl, String data,String accountid)
			throws Exception {
		...
		if(null !=accountid && accountid.length()>5){
			keyStorePath = PropsPaywxUtil.getProperty("keyStorePath_"+accountid);
			password = PropsPaywxUtil.getProperty("password_"+accountid);
		}
