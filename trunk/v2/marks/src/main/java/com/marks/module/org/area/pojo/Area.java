...
public class Area implements Serializable{
    ...
    */
	...
	public String toLog(){
		return " - areaId:" +String.valueOf(areaId)+" - areaName:" +String.valueOf(areaName)+" - companyId:" +String.valueOf(companyId)+" - lvl:" +String.valueOf(lvl)+" - createtime:" +String.valueOf(createtime)+" - updatetime:" +String.valueOf(updatetime)+" - parentId:" +String.valueOf(parentId)+" - parentName:" +String.valueOf(parentName)+" - lvl1Id:" +String.valueOf(lvl1Id)+" - lvl1Name:" +String.valueOf(lvl1Name)+" - lvl2Id:" +String.valueOf(lvl2Id)+" - lvl2Name:" +String.valueOf(lvl2Name)+" - lvl3Id:" +String.valueOf(lvl3Id)+" - lvl3Name:" +String.valueOf(lvl3Name)+" - lvl4Id:" +String.valueOf(lvl4Id)+" - lvl4Name:" +String.valueOf(lvl4Name)+" - lvl5Id:" +String.valueOf(lvl5Id)+" - lvl5Name:" +String.valueOf(lvl5Name);
	}
}