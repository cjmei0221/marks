...
public class PojoProduced extends AbstractCodeProduced {
	...
	public StringBuffer groupGetMethod(AttrType type, String attrName) {
		StringBuffer sBuffer = new StringBuffer();
		sBuffer.append(BANK_VALUE_4).append(DEFAULT_PUBLIC).append(BANK_VALUE_1).append(type.getJavaType())
				.append(BANK_VALUE_1).append(DEFAULT_GET).append(StringUtil.getUpperCaseChar(attrName))
				.append(LEFT_PATEN).append(RIGHT_PATEN).append(LEFT_BRACKETS);
		sBuffer.append(ENTER_VALUE);
		sBuffer.append(BANK_VALUE_4).append(BANK_VALUE_4).append(RETURN_VALUE).append(BANK_VALUE_1).append(attrName)
				.append(SEMI_VALUE);
	...
	public StringBuffer groupSetMethod(AttrType type, String attrName) {
		...
		sBuffer.append(BANK_VALUE_4).append(DEFAULT_PUBLIC).append(BANK_VALUE_1).append(VOID_VALUE).append(BANK_VALUE_1)
				.append(DEFAULT_SET).append(StringUtil.getUpperCaseChar(attrName)).append(LEFT_PATEN)
				.append(type.getJavaType()).append(BANK_VALUE_1).append(attrName).append(RIGHT_PATEN)
				.append(LEFT_BRACKETS);
		sBuffer.append(ENTER_VALUE);
		sBuffer.append(BANK_VALUE_4).append(BANK_VALUE_4).append(THIS_VALUE).append(attrName).append(BANK_VALUE_1)
				.append(EQUAL_VALUE).append(BANK_VALUE_1).append(attrName).append(SEMI_VALUE);
		sBuffer.append(ENTER_VALUE).append(BANK_VALUE_4).append(RIGHT_BRACKETS);
		sBuffer.append(ENTER_VALUE);
		return sBuffer;
	}
