package com.marks.smart.system.system.upload.util;
...
public class FTPUtil {
	...
	public static String ftp_flag = Config.ftp_flag;
	...
	public boolean uploadFTPImageInput(String ip, String login_name, String password, String ftpFileDirectory,
			String ftpFileNames, File files, String jid) {
		if ("N".equals(ftp_flag)) {
			return true;
		}
		try {
