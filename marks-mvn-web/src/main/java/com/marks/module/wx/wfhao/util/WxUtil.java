package com.marks.module.wx.wfhao.util;
...
import com.marks.module.wx.util.HttpUtils;
import com.marks.module.wx.util.JsonResult;
import com.marks.module.wx.wfhao.config.WxFwConfig;
	...
	public String getOpenIdByCode(String code, String accountid) {
		try {
			...
			String url = String.format(WxFwConfig.weixin_connect_oauth2_access_token, appid,
					appSercet, code);
			JsonResult result= HttpUtils.getInstance().doGetForOpenid(url, null, null, HttpUtils.charSet);
